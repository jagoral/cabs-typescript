...
describe('Calculate Driver Periodic Payments', () => {
  ...
  it('should calculate yearly payment', async () => {
    ...
    expect(payments.get(1)).toEqual(0);
    expect(payments.get(2)).toEqual(0);
    expect(payments.get(3)).toEqual(0);
    expect(payments.get(4)).toEqual(0);
    expect(payments.get(5)).toEqual(0);
    expect(payments.get(6)).toEqual(0);
    expect(payments.get(7)).toEqual(0);
    expect(payments.get(8)).toEqual(0);
    expect(payments.get(9)).toEqual(180);
    expect(payments.get(10)).toEqual(70);
    expect(payments.get(11)).toEqual(5);
  });
